...
export const TypographyH1 = React.forwardRef<HTMLHeadingElement, ComponentPropsWithoutRef<"h1">>(
  ({ className, ...props }, ref) => (
    <h1
      ref={ref}
      className={cn(
        "scroll-m-20 text-[calc(2.25rem*var(--text-scale))] font-extrabold tracking-tight lg:text-[calc(3rem*var(--text-scale))]",
        className,
      )}
      {...props}
    />
...
export const TypographyH2 = React.forwardRef<HTMLHeadingElement, ComponentPropsWithoutRef<"h2">>(
  ({ className, ...props }, ref) => (
    <h2
      ref={ref}
      className={cn(
        "scroll-m-20 border-b pb-2 text-[calc(1.875rem*var(--text-scale))] font-semibold tracking-tight transition-colors first:mt-0",
        className,
      )}
      {...props}
    />
...
export const TypographyH3 = React.forwardRef<HTMLHeadingElement, ComponentPropsWithoutRef<"h3">>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn("scroll-m-20 text-[calc(1.5rem*var(--text-scale))] font-semibold tracking-tight", className)}
      {...props}
    />
  ),
);
...
export const TypographyH4 = React.forwardRef<HTMLHeadingElement, ComponentPropsWithoutRef<"h4">>(
  ({ className, ...props }, ref) => (
    <h4
      ref={ref}
      className={cn("scroll-m-20 text-[calc(1.25rem*var(--text-scale))] font-semibold tracking-tight", className)}
      {...props}
    />
  ),
);
...
export const TypographyP = React.forwardRef<HTMLParagraphElement, ComponentPropsWithoutRef<"p">>(
  ({ className, ...props }, ref) => (
    <p
      ref={ref}
      className={cn("text-[calc(1rem*var(--text-scale))] leading-7 [&:not(:first-child)]:mt-6", className)}
      {...props}
    />
  ),
);
...
export const TypographyInlineCode = React.forwardRef<HTMLElement, ComponentPropsWithoutRef<"code">>(
  ({ className, ...props }, ref) => (
    <code
      ref={ref}
      className={cn(
        "relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-[calc(0.875rem*var(--text-scale))] font-semibold",
        className,
      )}
      {...props}
    />
...
export const TypographyLead = React.forwardRef<HTMLParagraphElement, ComponentPropsWithoutRef<"p">>(
  ({ className, ...props }, ref) => (
    <p ref={ref} className={cn("text-[calc(1.25rem*var(--text-scale))] text-muted-foreground", className)} {...props} />
  ),
);
...
export const TypographyLarge = React.forwardRef<HTMLDivElement, ComponentPropsWithoutRef<"div">>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("text-[calc(1.125rem*var(--text-scale))] font-semibold", className)} {...props} />
  ),
);
...
export const TypographySmall = React.forwardRef<HTMLElement, ComponentPropsWithoutRef<"small">>(
  ({ className, ...props }, ref) => (
    <small
      ref={ref}
      className={cn("text-[calc(0.875rem*var(--text-scale))] font-medium leading-none", className)}
      {...props}
    />
  ),
);
...
export const TypographyMuted = React.forwardRef<HTMLParagraphElement, ComponentPropsWithoutRef<"p">>(
  ({ className, ...props }, ref) => (
    <p
      ref={ref}
      className={cn("text-[calc(0.875rem*var(--text-scale))] text-muted-foreground", className)}
      {...props}
    />
  ),
);
...
export const PageHeader1 = React.forwardRef<HTMLHeadingElement, ComponentPropsWithoutRef<"h2">>(
  ({ className, ...props }, ref) => (
    <h2
      ref={ref}
      className={cn("text-[calc(1.5rem*var(--text-scale))] font-bold tracking-tight", className)}
      {...props}
    />
  ),
);
...
export const PageHeader2 = React.forwardRef<HTMLHeadingElement, ComponentPropsWithoutRef<"h3">>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn("text-[calc(1.125rem*var(--text-scale))] font-medium", className)} {...props} />
  ),
);
